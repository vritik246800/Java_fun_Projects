			...
			switch(op)
			{
				case 1:
					...
					do
					{
						...
						System.out.println("|-------------------------------|");
						System.out.println("|3. Registo de cliente          |");
						System.out.println("|-------------------------------|");
						System.out.println("|4. Movimento                   |");
						System.out.println("|-------------------------------|");
						System.out.println("|5. Return para menu !          |");
						System.out.println("|===============================|\n");
						...
						switch(op)
						{
							...
							case 4:
								...
								{
									System.out.println("|===============================|");
									System.out.println("|1. Deposito de Valor           |");
									System.out.println("|-------------------------------|");
									System.out.println("|2. Levantamento de dinheiro    |");
									System.out.println("|-------------------------------|");
									System.out.println("|3. Tranferencia de dinheiro    |");
									System.out.println("|-------------------------------|");
									System.out.println("|4. Return para opcao anterior  |");
									System.out.println("|===============================|");
									op=val.opcao();
									switch(op)
									{

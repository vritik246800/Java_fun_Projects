...
public class Suspeito extends Individuo
{
	...
	public Suspeito(String nome, String gen, String nac, String numBI, String end, String numTelefone, int idade,String grauPer, String estadoDet, String depoimento, String antecedentes, String advogado)
	{
	...
	public Suspeito(String novo)
	{
		...
		escrever.escreverSuspeito(nome, idade, genero, nacionalidade, numeroBI, endereco, numTelefone, grauPericulosidade,antecedentesCriminais,estadoDetensao,depoimento,advogadoPresente);
	}
